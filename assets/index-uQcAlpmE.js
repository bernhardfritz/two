...
async function C(e) {
  const t = e.gl;
  await import(new URL("/wasm_exec.js", e.baseURI).href);
  const o = new Go();
  let a;
  const n = {};
  ...
  o.importObject.env = {
    ...
    // ... other functions
  }, M(fetch(new URL("/main.wasm", e.baseURI)), o.importObject).then(async function(f) {
